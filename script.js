...
const translations = {
  fr: {
    ...
    "prices.eyebrow": "Indicateurs du marche de l'energie",
    "prices.title": "Prix benchmark du brut et des produits raffines.",
  ...
  es: {
    ...
    "prices.eyebrow": "Indicadores del mercado energetico",
  ...
  de: {
    ...
    "prices.title": "Benchmarkpreise fur Rohol und Raffinerieprodukte.",
